      ...
      <div className="container mx-auto px-6 relative z-10 text-center">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-indigo-600/10 backdrop-blur-md border border-indigo-600/20">
             ...
             <span className="text-xs font-black uppercase tracking-[0.2em] text-indigo-600">Discover our journey</span>
          </div>
          ...
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-black text-slate-900 leading-[1.05] tracking-tighter mb-8 max-w-5xl mx-auto">
            We Craft the Future of <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-purple-600 italic">Premium Retail.</span>
          </h1>
          
          <p className="text-lg md:text-xl text-slate-600 max-w-3xl mx-auto mb-12 leading-relaxed font-medium">
            Founded in 2024, MYSTORE was born out of a simple idea: to make luxury accessible. 
            We've evolved from a local boutique to a global pioneer in digital commerce.
          </p>
